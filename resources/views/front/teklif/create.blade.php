    ...
    <div class="row page-title clearfix">
        ...
        <div class="page-title-right d-none d-sm-inline-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Teklif Oluştur</li>
            </ol>
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <form action="{{ route('teklif.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" required name="fiyat"  type="text">
                                </div>
                                <div class="col-md-12">
